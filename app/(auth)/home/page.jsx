            ...
            <div className='flex w-full h-screen'>
                <div className='flex flex-col p-5  mt-4 ml-4 h-[80%]'>
                    ...
                    <div className='flex mt-3 w-full gap-1 h-[50%]'>
                        <button className='flex items-center justify-center border rounded-sm bg-black text-white w-[30%] h-[15%]  cursor-pointer'>Upload Resume </button>
                        <button className='flex items-center justify-around border rounded-sm bg-white text-black w-[30%] h-[15%] cursor-pointer'><i className="ri-linkedin-box-line text-xl mr-3"></i>Sign-up with LinkedIn </button>
                    </div>
                </div>
                <div> // div for image
